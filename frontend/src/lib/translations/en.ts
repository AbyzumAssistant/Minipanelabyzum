export const en = {
  ...
  finishInitialSetupDescription: 'Create the first admin account to start using abyzumMC.',
  ...
  acceptInvitationDesc: 'Create your abyzumMC account to continue.',
  ...
  backupHostDirDesc: 'Host path where backup files are physically stored (e.g. /network-disk/abyzumMC). Leave empty to use the global default location.',
  ...
  cmdTitleBroadcast: 'Screen title (all)',
  cmdTellrawBroadcast: 'JSON message (tellraw)',
  cmdSpreadPlayers: 'Spread players',
  cmdMobSpawningOff: 'Disable mob spawning',
  cmdMobSpawningOn: 'Enable mob spawning',
  cmdImmediateRespawn: 'Instant respawn ON',
  cmdAnnounceAdvancementsOff: 'Hide advancements',
  cmdDefaultGamemodeSurvival: 'Default gamemode: survival',
  cmdDefaultGamemodeCreative: 'Default gamemode: creative',
  cmdGiveIronPickaxe: 'Give iron pickaxe',
  cmdGiveBread: 'Give bread (64)',
  cmdGiveShield: 'Give shield',
  cmdGiveBow: 'Give bow',
  cmdEffectResistance: 'Resistance (all)',
  cmdEffectNightVision: 'Night vision (all)',
  cmdEffectSaturation: 'Saturation (all)',
  cmdKillArrows: 'Clear arrows',
  cmdSetXpLevel: 'Set XP to level 30',
  cmdAddTime: 'Advance time (+1000)',
  cmdFreezeRandomTick: 'Freeze random ticks',
  cmdUnfreezeRandomTick: 'Restore random ticks',
  cmdForgeChunkInfo: 'Forge chunk info',
  cmdStopRain: 'Stop rain now',
  cmdHealAll: 'Heal all',
  cmdFeedAll: 'Feed all',
  ...
  landingTabDesc: 'Public landing page and MCABYZUM.exe download. Mods sync on launch; not bundled in the installer.',
  landingBuildButton: 'Prepare launcher (.exe)',
  landingDownloadButton: 'Download launcher (.exe)',
  landingBuildSuccess: 'Launcher prepared successfully',
  landingBuildError: 'Could not prepare launcher',
  landingLoadError: 'Could not load landing status',
  landingNoMods: 'Configure mods before preparing the launcher',
  landingPageUrl: 'Public landing URL',
  landingBuildHint: 'Players download MCABYZUM.exe. Minecraft and mods install to AppData on first use; if up to date, they join instantly.',
  landingLastBuilt: 'Last prepared',
  landingPackTitle: 'MCABYZUM launcher',
  landingPackMods: 'Mods published on panel',
  landingPackSize: '.exe size',
  landingNoBuildYet: 'No build yet — click Prepare launcher (.exe) first.',
  ...
  bedrockAddonsProcessingHint: 'Please wait while abyzumMC extracts files and syncs packs to the active world.',
