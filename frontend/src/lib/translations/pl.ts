...
export const pl: Record<TranslationKey, string> = {
  ...
  finishInitialSetupDescription: 'Utwórz pierwsze konto administratora, aby rozpocząć korzystanie z abyzumMC.',
  ...
  acceptInvitationDesc: 'Utwórz swoje konto abyzumMC, aby kontynuować.',
  ...
  backupHostDirDesc: 'Ścieżka hosta, w której fizycznie przechowywane są pliki kopii zapasowych (np. /network-disk/abyzumMC). Pozostaw puste, aby użyć globalnej lokalizacji domyślnej.',
  ...
  cmdTitleBroadcast: 'Tytuł na ekranie (wszyscy)',
  cmdTellrawBroadcast: 'Wiadomość JSON (tellraw)',
  cmdSpreadPlayers: 'Rozprosz graczy',
  cmdMobSpawningOff: 'Wyłącz spawn mobów',
  cmdMobSpawningOn: 'Włącz spawn mobów',
  cmdImmediateRespawn: 'Natychmiastowy respawn',
  cmdAnnounceAdvancementsOff: 'Ukryj postępy',
  cmdDefaultGamemodeSurvival: 'Domyślny tryb: survival',
  cmdDefaultGamemodeCreative: 'Domyślny tryb: creative',
  cmdGiveIronPickaxe: 'Daj kilof żelazny',
  cmdGiveBread: 'Daj chleb (64)',
  cmdGiveShield: 'Daj tarczę',
  cmdGiveBow: 'Daj łuk',
  cmdEffectResistance: 'Odporność (wszyscy)',
  cmdEffectNightVision: 'Noktowizja (wszyscy)',
  cmdEffectSaturation: 'Nasycenie (wszyscy)',
  cmdKillArrows: 'Usuń strzały',
  cmdSetXpLevel: 'XP poziom 30',
  cmdAddTime: 'Czas +1000',
  cmdFreezeRandomTick: 'Zatrzymaj random tick',
  cmdUnfreezeRandomTick: 'Przywróć random tick',
  cmdForgeChunkInfo: 'Info chunków Forge',
  cmdStopRain: 'Zatrzymaj deszcz',
  cmdHealAll: 'Ulecz wszystkich',
  cmdFeedAll: 'Nakarm wszystkich',
  ...
  bedrockAddonsProcessingHint: 'Poczekaj, aż abyzumMC rozpakowuje pliki i synchronizuje paczki z aktywnym światem.',
