...
export const de: Record<TranslationKey, string> = {
  ...
  finishInitialSetupDescription: 'Erstellen Sie das erste Administratorkonto, um abyzumMC zu starten.',
  ...
  acceptInvitationDesc: 'Erstelle dein abyzumMC-Konto, um fortzufahren.',
  ...
  backupHostDirDesc: 'Host-Pfad, in dem die Backup-Dateien physisch gespeichert werden (z. B. /network-disk/abyzumMC). Leer lassen, um den globalen Standardspeicherort zu verwenden.',
  ...
  cmdTitleBroadcast: 'Bildschirmtitel (alle)',
  cmdTellrawBroadcast: 'JSON-Nachricht (tellraw)',
  cmdSpreadPlayers: 'Spieler verteilen',
  cmdMobSpawningOff: 'Mob-Spawning aus',
  cmdMobSpawningOn: 'Mob-Spawning an',
  cmdImmediateRespawn: 'Sofort-Respawn AN',
  cmdAnnounceAdvancementsOff: 'Fortschritte ausblenden',
  cmdDefaultGamemodeSurvival: 'Standard: Überleben',
  cmdDefaultGamemodeCreative: 'Standard: Kreativ',
  cmdGiveIronPickaxe: 'Eisenspitzhacke geben',
  cmdGiveBread: 'Brot geben (64)',
  cmdGiveShield: 'Schild geben',
  cmdGiveBow: 'Bogen geben',
  cmdEffectResistance: 'Resistenz (alle)',
  cmdEffectNightVision: 'Nachtsicht (alle)',
  cmdEffectSaturation: 'Sättigung (alle)',
  cmdKillArrows: 'Pfeile entfernen',
  cmdSetXpLevel: 'XP auf Stufe 30 setzen',
  cmdAddTime: 'Zeit +1000',
  cmdFreezeRandomTick: 'Random Ticks einfrieren',
  cmdUnfreezeRandomTick: 'Random Ticks wiederherstellen',
  cmdForgeChunkInfo: 'Forge Chunk-Info',
  cmdStopRain: 'Regen stoppen',
  cmdHealAll: 'Alle heilen',
  cmdFeedAll: 'Alle füttern',
  ...
  bedrockAddonsProcessingHint: 'Bitte warten, während abyzumMC Dateien entpackt und Packs mit der aktiven Welt synchronisiert.',
