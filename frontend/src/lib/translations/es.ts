...
export const es: Record<TranslationKey, string> = {
  ...
  landingBuildButton: 'Construir paquete launcher',
  landingDownloadButton: 'Descargar launcher (.zip)',
  landingBuildSuccess: 'Paquete launcher construido correctamente',
  landingBuildError: 'No se pudo construir el paquete launcher',
  landingLoadError: 'No se pudo cargar el estado de la landing',
  landingNoMods: 'Configura mods antes de construir el launcher',
  landingPageUrl: 'URL pública de la landing',
  landingBuildHint: 'Los jugadores descargan MCABYZUM-Launcher.exe con todos los mods para entrar al instante.',
  landingLastBuilt: 'Última construcción',
  landingPackTitle: 'Paquete launcher',
  landingPackMods: 'Mods incluidos',
  landingPackSize: 'Tamaño del paquete',
  landingNoBuildYet: 'Aún no hay build — pulsa Construir paquete launcher.',
