...
export const es: Record<TranslationKey, string> = {
  ...
  finishInitialSetupDescription: 'Crea la primera cuenta administradora para empezar a usar abyzumMC.',
  ...
  saveServerHint: 'Pulsa para guardar la config actual en el panel',
  ...
  acceptInvitationDesc: 'Crea tu cuenta de abyzumMC para continuar.',
  ...
  backupHostDirDesc: 'Ruta del host donde se almacenan físicamente los backups (ej. /network-disk/abyzumMC). Déjalo vacío para usar la ubicación global por defecto.',
  ...
  cmdTitleBroadcast: 'Título en pantalla (todos)',
  cmdTellrawBroadcast: 'Mensaje JSON (tellraw)',
  cmdSpreadPlayers: 'Repartir jugadores',
  cmdMobSpawningOff: 'Desactivar spawn de mobs',
  cmdMobSpawningOn: 'Activar spawn de mobs',
  cmdImmediateRespawn: 'Respawn instantáneo ON',
  cmdAnnounceAdvancementsOff: 'Ocultar logros',
  cmdDefaultGamemodeSurvival: 'Modo por defecto: supervivencia',
  cmdDefaultGamemodeCreative: 'Modo por defecto: creativo',
  cmdGiveIronPickaxe: 'Dar pico de hierro',
  cmdGiveBread: 'Dar pan (64)',
  cmdGiveShield: 'Dar escudo',
  cmdGiveBow: 'Dar arco',
  cmdEffectResistance: 'Resistencia (todos)',
  cmdEffectNightVision: 'Visión nocturna (todos)',
  cmdEffectSaturation: 'Saturación (todos)',
  cmdKillArrows: 'Limpiar flechas',
  cmdSetXpLevel: 'Fijar XP a nivel 30',
  cmdAddTime: 'Avanzar tiempo (+1000)',
  cmdFreezeRandomTick: 'Congelar ticks aleatorios',
  cmdUnfreezeRandomTick: 'Restaurar ticks aleatorios',
  cmdForgeChunkInfo: 'Info chunks Forge',
  cmdStopRain: 'Parar lluvia ya',
  cmdHealAll: 'Curar a todos',
  cmdFeedAll: 'Alimentar a todos',
  ...
  modDeployTitle: 'Despliegue de mods',
  modDeployDesc: 'Publica la lista de mods y el resource pack que los jugadores deben instalar antes de entrar.',
  modDeployPlayerLink: 'Enlace de descarga para jugadores',
  modDeployPlayerLinkDesc: 'Comparte este enlace para que acepten y descarguen mods y packs obligatorios.',
  modDeployPreview: 'Vista previa',
  modDeployAntiXray: 'Anti x-ray (resource packs)',
  lockClientResourcePacks: 'Bloquear resource packs extra del cliente',
  lockClientResourcePacksDesc: 'Obliga el pack oficial del servidor y evita packs personalizados con x-ray.',
  resourcePackUrl: 'URL del resource pack del servidor',
  resourcePackSha1: 'SHA1 del resource pack',
  requireResourcePack: 'Exigir resource pack al entrar',
  requireResourcePackDesc: 'Los jugadores deben aceptar el pack del servidor para conectarse.',
  modDeployPublish: 'Publicar despliegue',
  modDeploySyncServer: 'Sincronizar mods al servidor',
  modDeployServerSynced: 'Mods sincronizados al servidor. Reinicia si no arrancó solo.',
  modDeployServerSyncError: 'No se pudieron sincronizar los mods al servidor',
  modDeployLoadError: 'No se pudo cargar el manifiesto de despliegue',
  modDeploySaveError: 'No se pudo guardar el despliegue',
  modDeploySaved: 'Despliegue publicado',
  modDeployNoMods: 'Aún no hay mods configurados',
  modDeployRootMods: 'Mods seleccionados',
  modDeployDependencies: 'Dependencias resueltas automáticamente',
  modDeployLinkCopied: 'Enlace copiado',
  modDeployServerAddress: 'Dirección del servidor (Minecraft)',
  modDeployServerAddressDesc: 'Se guarda en el manifest del launcher al sincronizar. Los jugadores conectan aquí directo.',
  modDeployServerAddressCopied: 'Dirección del servidor copiada',
  launcherSyncTitle: 'Launcher MCABYZUM',
  ...
  landingTabDesc: 'Página pública y descarga del launcher (.exe). Los mods se sincronizan al entrar; no van embebidos en el instalador.',
  landingBuildButton: 'Preparar launcher (.exe)',
  landingDownloadButton: 'Descargar launcher (.exe)',
  landingBuildSuccess: 'Launcher preparado correctamente',
  landingBuildError: 'No se pudo preparar el launcher',
  landingLoadError: 'No se pudo cargar el estado de la landing',
  landingNoMods: 'Configura mods antes de preparar el launcher',
  landingPageUrl: 'URL pública de la landing',
  landingBuildHint: 'Los jugadores descargan MCABYZUM.exe. Minecraft y mods se instalan en AppData al primer uso; si ya están al día, entran directo.',
  landingLastBuilt: 'Última preparación',
  landingPackTitle: 'Launcher MCABYZUM',
  landingPackMods: 'Mods publicados en el panel',
  landingPackSize: 'Tamaño del .exe',
  landingNoBuildYet: 'Aún no hay build — pulsa Preparar launcher (.exe).',
  landingDownloadStarted: 'Descarga iniciada',
  landingLoading: 'Cargando landing…',
  forge119CatalogTitle: 'Catálogo Forge 1.19',
  forge119CatalogDesc: 'Mods curados de Modrinth por categoría. Las dependencias se incluyen solas.',
  forgeCatalogLoading: 'Cargando catálogo…',
  forgeCatalogLoadError: 'No se pudo cargar el catálogo de mods',
  forgeCatalogSelectOne: 'Selecciona al menos un mod',
  forgeCatalogApplied: 'Mods aplicados con dependencias',
  forgeCatalogApplyError: 'No se pudieron aplicar los mods',
  forgeCatalogDownloadWithDeps: 'Descargar con dependencias',
  forgeCatalogEmptyCategory: 'No hay mods compatibles en esta categoría',
  forgeCatalogSeeMore: 'Ver más',
  forgeCatalogSearchPlaceholder: 'Buscar mods Forge 1.19…',
  forgeCatalogSearchHint: 'Solo se muestran mods compatibles con Forge 1.19.2.',
  forgeCatalogSearchEmpty: 'No se encontraron mods compatibles con esa búsqueda.',
  forgeCatalogSearching: 'Buscando…',
  forgeCatalogClearSearch: 'Limpiar búsqueda',
  forgeCatalogIncompatible: 'Sin versión Forge 1.19.2',
  forgeCatalogNotFound: 'No encontrado en Modrinth',
  forgeCatalogClientOnly: 'Solo cliente',
  forgeCatalogCompatWarning: 'Avisos de compatibilidad',
  forgeCatalogSelectCompatible: 'Este mod no es compatible con Forge 1.19.2',
  forgeCatalogReadyTitle: 'Listos para Forge 1.19.2',
  forgeCatalogSkippedTitle: 'No se incluirán',
  forgeCatalogNoneCompatible: 'Ningún mod seleccionado es compatible con Forge 1.19.2',
  forgeCatalogAppliedPartial: '{applied} mods aplicados, {skipped} omitidos por compatibilidad',
  paperMcBuilderTitle: 'PaperMC',
  paperMcBuilderDesc: 'Explora plugins, arrástralos al bloque y genera un ZIP descargable.',
  paperMcDropZone: 'Tu pack de plugins',
  paperMcDropZoneHint: 'Arrastra plugins aquí o haz clic en una tarjeta para añadirlos.',
  paperMcDropZoneEmpty: 'Arrastra plugins aquí para armar tu pack',
  paperMcMakePlugin: 'Hacer plugin',
  paperMcBuilding: 'Generando…',
  paperMcBuildSuccess: 'Pack de plugins listo y descargado',
  paperMcBuildError: 'No se pudo generar el pack de plugins',
  paperMcSelectOne: 'Añade al menos un plugin',
  paperMcCatalogLoading: 'Cargando catálogo…',
  paperMcCatalogLoadError: 'No se pudo cargar el catálogo de plugins',
  paperMcEmptyCategory: 'No hay plugins compatibles en esta categoría',
  paperMcIncompatible: 'Sin versión para esta versión de Minecraft',
  paperMcPluginAdded: 'Plugin añadido al pack',
  paperMcDragHint: 'Arrastra una tarjeta al bloque de la derecha, o haz clic para añadir.',
  paperMcSelectedCount: 'plugins seleccionados',
  paperMcRemove: 'Quitar',
  ...
  forge119Optimized: 'Forge 1.19 Optimizado',
  forge119OptimizedDesc: 'Servidor Forge 1.19.2 con flags JVM Aikar y distancias de render optimizadas.',
  horizonsAbyzum: 'abyzumMC Horizons',
  horizonsAbyzumDesc: 'Modpack Horizons (Fabric 1.20.1) con mods, resource packs y launcher abyzum.',
  horizonsModpackTitle: 'Modpack Horizons (abyzumMC)',
  horizonsModpackDesc: 'Instala el modpack completo de Modrinth (mods, configs y resource packs). Los shaders Bliss se descargan aparte — el launcher te indica cómo.',
  horizonsModpackPublish: 'Publicar Horizons en abyzumMC',
  ...
  bedrockAddonsProcessingHint: 'Espera mientras abyzumMC extrae archivos y sincroniza los packs con el mundo activo.',
