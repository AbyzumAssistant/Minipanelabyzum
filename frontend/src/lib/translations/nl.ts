...
export const nl: Record<TranslationKey, string> = {
  ...
  finishInitialSetupDescription: 'Maak het eerste beheerdersaccount aan om abyzumMC te gebruiken.',
  ...
  acceptInvitationDesc: 'Maak je abyzumMC-account aan om door te gaan.',
  ...
  backupHostDirDesc: 'Hostpad waar back-upbestanden fysiek worden opgeslagen (bijv. /network-disk/abyzumMC). Laat leeg om de globale standaardlocatie te gebruiken.',
  ...
  cmdTitleBroadcast: 'Schermtitel (iedereen)',
  cmdTellrawBroadcast: 'JSON-bericht (tellraw)',
  cmdSpreadPlayers: 'Spelers spreiden',
  cmdMobSpawningOff: 'Mob spawn uit',
  cmdMobSpawningOn: 'Mob spawn aan',
  cmdImmediateRespawn: 'Direct respawn AAN',
  cmdAnnounceAdvancementsOff: 'Voortgang verbergen',
  cmdDefaultGamemodeSurvival: 'Standaard: survival',
  cmdDefaultGamemodeCreative: 'Standaard: creative',
  cmdGiveIronPickaxe: 'Geef ijzeren houweel',
  cmdGiveBread: 'Geef brood (64)',
  cmdGiveShield: 'Geef schild',
  cmdGiveBow: 'Geef boog',
  cmdEffectResistance: 'Weerstand (iedereen)',
  cmdEffectNightVision: 'Nachtzicht (iedereen)',
  cmdEffectSaturation: 'Verzadiging (iedereen)',
  cmdKillArrows: 'Pijlen wissen',
  cmdSetXpLevel: 'XP niveau 30',
  cmdAddTime: 'Tijd +1000',
  cmdFreezeRandomTick: 'Random ticks bevriezen',
  cmdUnfreezeRandomTick: 'Random ticks herstellen',
  cmdForgeChunkInfo: 'Forge chunk info',
  cmdStopRain: 'Regen stoppen',
  cmdHealAll: 'Iedereen healen',
  cmdFeedAll: 'Iedereen voeden',
  ...
  bedrockAddonsProcessingHint: 'Wacht terwijl abyzumMC bestanden uitpakt en packs synchroniseert met de actieve wereld.',
